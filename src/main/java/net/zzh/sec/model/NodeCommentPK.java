...
/**
 * The primary key class for the node_comment database table.
 * 
 */
@Embeddable
public class NodeCommentPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeCommentPK)) {
			return false;
		}
		NodeCommentPK castOther = (NodeCommentPK)other;
		return 

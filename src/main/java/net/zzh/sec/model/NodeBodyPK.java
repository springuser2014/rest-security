...
/**
 * The primary key class for the node_body database table.
 * 
 */
@Embeddable
public class NodeBodyPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeBodyPK)) {
			return false;
		}
		NodeBodyPK castOther = (NodeBodyPK)other;
		return 

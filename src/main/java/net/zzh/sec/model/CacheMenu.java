...
/**
 * The persistent class for the cache_menu database table.
 * 
 */
@Entity
@Table(name="cache_menu")
@NamedQuery(name="CacheMenu.findAll", query="SELECT c FROM CacheMenu c")
public class CacheMenu implements Serializable, net.zzh.common.persistence.model.INameableEntity {
